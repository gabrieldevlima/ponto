...
if (!has_permission('leaves.manage')) {
    ...
    flash_redirect('error', 'Sem permissão.', 'dashboard.php');
}
$pdo = db();
...
<body>
    ...
    <div class="container-fluid admin-content">
        ...
        <!-- Header -->
        <div class="app-page-header"><div class="app-page-header__main"><div class="app-page-icon"><i class="bi bi-person-x"></i></div><div><h1 class="app-page-title">Afastamentos / Licencas / Abonos</h1><p class="app-page-subtitle">Cadastre e gerencie afastamentos por colaborador, tipo e periodo.</p></div></div><button class="btn btn-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasLeave" onclick="resetForm()">
        ...
        <div class="card shadow-sm mb-4">
            <div class="card-header d-flex align-items-center justify-content-between" role="button" data-bs-toggle="collapse" data-bs-target="#filtersBody" aria-expanded="true" style="cursor:pointer;">
                <span class="fw-semibold"><i class="bi bi-funnel me-2"></i>Filtros</span>
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex align-items-center justify-content-between">
                ...
                <span class="badge bg-secondary rounded-pill"><?= number_format($totalLeaves) ?> resultado(s)</span>
            </div>
                ...
                <table class="table table-bordered table-hover align-middle table-sm mb-0">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-center" style="width:90px;">Acoes</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="card-footer">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3">
                    <a class="btn btn-secondary btn-sm" href="dashboard.php"><i class="bi bi-arrow-left-short me-1"></i>Voltar</a>
                    <a class="btn btn-outline-primary btn-sm" href="leaves.php"><i class="bi bi-arrow-clockwise me-1"></i>Atualizar</a>
                </div>
            </div>
        </div>
    </div>
