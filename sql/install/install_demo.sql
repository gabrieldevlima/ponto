...
-- =====================================================================
-- 4. COLABORADORES (PIN 123456 para todos)
-- =====================================================================
-- pin_hash = password_hash('123456', PASSWORD_DEFAULT)

SET @pin = '$2y$10$JQyrFwtwgCXl0kRaNIgYyOWDHE0u2bWXNq93iyIQAmv4ebjNWP75K';

INSERT IGNORE INTO teachers (id, name, cpf, pin_hash, email, active, type_id, base_salary, network_wide) VALUES
-- Professores (type_id = 1)
(1,  'Ana Beatriz Sousa Lima',       '111.222.333-01', @pin, 'ana.lima@demo.com',       1, 1, 3200.00, 0),
(2,  'Carlos Eduardo Mendes',        '222.333.444-02', @pin, 'carlos.mendes@demo.com',  1, 1, 3400.00, 0),
(3,  'Fernanda Oliveira Costa',      '333.444.555-03', @pin, 'fernanda.costa@demo.com', 1, 1, 3100.00, 0),
(4,  'Joao Victor Alves Pereira',    '444.555.666-04', @pin, 'joao.pereira@demo.com',   1, 1, 3300.00, 0),
(5,  'Patricia Rodrigues Silva',     '555.666.777-05', @pin, 'patricia.silva@demo.com', 1, 1, 3250.00, 0),
-- Coordenadores (type_id = 2)
(6,  'Marcelo Henrique Tavares',     '666.777.888-06', @pin, 'marcelo.tavares@demo.com',1, 2, 4500.00, 0),
(7,  'Rosana Freitas Monteiro',      '777.888.999-07', @pin, 'rosana.monteiro@demo.com',1, 2, 4300.00, 0),
(8,  'Thiago Santos Nascimento',     '888.999.000-08', @pin, 'thiago.nasc@demo.com',    1, 2, 4400.00, 0),
-- Administrativos (type_id = 3)
(9,  'Luciana Carvalho Pinto',       '999.000.111-09', @pin, 'luciana.pinto@demo.com',  1, 3, 2800.00, 0),
(10, 'Roberto Dias Ferreira',        '000.111.222-10', @pin, 'roberto.dias@demo.com',   1, 3, 2900.00, 0);
...
(4, 2, DATE_SUB(CURDATE(), INTERVAL 15 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'12:00:00'), -6.7693, -43.0215, 19.0, -6.7691, -43.0213, 16.0, 'pin', '189.40.10.4', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:05'), 'synced', 1, 1),
(5, 2, DATE_SUB(CURDATE(), INTERVAL 15 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:40:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'11:50:00'), -6.7690, -43.0212, 21.0, -6.7692, -43.0214, 19.0, 'pin', '189.40.10.5', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:40:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:40:05'), 'synced', 1, 1),
(6, 1, DATE_SUB(CURDATE(), INTERVAL 15 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'12:01:00'), -5.0922, -42.8037, 10.0, -5.0921, -42.8036, 10.0, 'pin', '189.40.10.6', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:30:05'), 'synced', 1, 1),
(7, 2, DATE_SUB(CURDATE(), INTERVAL 15 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'12:00:00'), -6.7691, -43.0213, 13.0, -6.7691, -43.0213, 11.0, 'pin', '189.40.10.7', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'07:29:05'), 'synced', 1, 1),
-- Pendente de aprovacao (sem check_out, approved = NULL)
(8, 3, DATE_SUB(CURDATE(), INTERVAL 15 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'13:02:00'), NULL, -7.0780, -41.4678, 22.0, NULL, NULL, NULL, 'pin', '189.40.10.8', NULL, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'13:02:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 15 DAY),'13:02:05'), 'synced', 0, 1),

-- Semana 1 (8-4 dias atras)
(1, 1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'12:03:00'), -5.0921, -42.8036, 14.0, -5.0920, -42.8035, 13.0, 'pin', '189.40.10.1', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:29:05'), 'synced', 1, 1),
(2, 1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'12:07:00'), -5.0920, -42.8033, 13.0, -5.0919, -42.8034, 12.0, 'pin', '189.40.10.2', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:05'), 'synced', 1, 1),
(3, 1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'11:59:00'), -5.0918, -42.8035, 16.0, -5.0919, -42.8034, 12.0, 'pin', '189.40.10.3', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:05'), 'synced', 1, 1),
(4, 2, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:28:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'12:04:00'), -6.7693, -43.0215, 20.0, -6.7691, -43.0213, 17.0, 'pin', '189.40.10.4', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:28:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:28:05'), 'synced', 1, 1),
(5, 2, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:36:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'11:57:00'), -6.7690, -43.0212, 22.0, -6.7692, -43.0214, 20.0, 'pin', '189.40.10.5', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:36:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:36:05'), 'synced', 1, 1),
(6, 1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'12:00:00'), -5.0922, -42.8037, 11.0, -5.0921, -42.8036, 11.0, 'pin', '189.40.10.6', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:31:05'), 'synced', 1, 1),
(7, 2, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'12:01:00'), -6.7691, -43.0213, 14.0, -6.7691, -43.0213, 12.0, 'pin', '189.40.10.7', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'07:30:05'), 'synced', 1, 1),
(8, 3, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'13:01:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'17:30:00'), -7.0780, -41.4678, 21.0, -7.0779, -41.4677, 18.0, 'pin', '189.40.10.8', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'13:01:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'13:01:05'), 'synced', 1, 1),
(9, 1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:01:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'17:00:00'), -5.0920, -42.8034, 17.0, -5.0920, -42.8034, 15.0, 'pin', '189.40.10.9', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:01:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:01:05'), 'synced', 1, 1),
(10,1, DATE_SUB(CURDATE(), INTERVAL 8 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:03:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'17:02:00'), -5.0919, -42.8033, 18.0, -5.0920, -42.8034, 16.0, 'pin', '189.40.10.10',1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:03:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 8 DAY),'08:03:05'), 'synced', 1, 1),

-- Ontem (1 dia atras) - alguns aprovados, 1 pendente
(1, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'12:00:00'), -5.0921, -42.8036, 14.0, -5.0920, -42.8035, 12.0, 'pin', '189.40.10.1', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:30:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:30:05'), 'synced', 1, 1),
...
(3, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'12:01:00'), -5.0918, -42.8035, 15.0, -5.0919, -42.8034, 13.0, 'pin', '189.40.10.3', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:31:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:31:05'), 'synced', 1, 1),
(4, 2, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'12:03:00'), -6.7693, -43.0215, 19.0, -6.7691, -43.0213, 16.0, 'pin', '189.40.10.4', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:29:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:29:05'), 'synced', 1, 1),
...
(6, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:32:00'), NULL, -5.0922, -42.8037, 12.0, NULL, NULL, NULL, 'pin', '189.40.10.6', NULL, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:32:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'07:32:05'), 'synced', 0, 1),
(9, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:00:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'17:01:00'), -5.0920, -42.8034, 16.0, -5.0920, -42.8034, 14.0, 'pin', '189.40.10.9', 1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:00:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:00:05'), 'synced', 1, 1),
(10,1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:04:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'17:00:00'), -5.0919, -42.8033, 17.0, -5.0920, -42.8034, 15.0, 'pin', '189.40.10.10',1, 'online', TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:04:00'), TIMESTAMP(DATE_SUB(CURDATE(),INTERVAL 1 DAY),'08:04:05'), 'synced', 1, 1);
...
SELECT
    ...
    'PIN dos colaboradores: 123456' AS pin_demo;
